		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comuidocumentui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comuidocumentui-display": {
								"semanticObject": "comuidocumentui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ui.document.ui",
									"url": sap.ui.require.toUrl("com/ui/document/ui")
								}
							}
						}
					}
